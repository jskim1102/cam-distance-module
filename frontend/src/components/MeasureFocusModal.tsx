...
interface Props {
  ...
  homography: number[][];
  // 2차 다항식 매핑(어안 왜곡 보정) — 있으면 측정에 우선 사용.
  poly?: Poly | null;
  onClose: () => void;
}
...
export default function MeasureFocusModal({ cam, homography, poly = null, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="measure-stage">
        ...
        <MeasureOverlay videoRef={videoRef} homography={homography} poly={poly} />
      </div>
